...
def train(
    ...
    for epoch in trange(num_epochs, desc="Epochs", position=0):
        ...
        if log_dir is not None:
            ...
            torch.save(info, log_dir / "checkpoint.pt")
...
if __name__ == "__main__":
    ...
    c = args.dataset
    d = args.batch_size
    run_name = f"{c}_{model.__class__.__name__}_lr{args.lr}_m{b}_bs{d}"
    args.log_dir = args.log_dir / run_name
    train(model, data_train, data_val, a, args.lr, b, args.device, args.log_dir)
